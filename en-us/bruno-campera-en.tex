...
\textbf{\textsc{Software Engineer}} at \textbf{Stoneridge} -- Full time \hfill \textit{07/2024 -- Current}
...
\begin{itemize}[leftmargin=*,label=\large\textbullet]
    ...
    \item Implemented application integrations with AWS RDS, DynamoDB, SQS, S3, Kinesis and Secrets services.
...
\textbf{\textsc{Software Engineer}} at \textbf{F\&S Technologies} -- Contractor \hfill \textit{12/2023 -- 12/2024}
...
\textbf{\textsc{Software Engineer}} at \textbf{Federal Data Processing Service (SERPRO)} -- Full time \hfill \textit{09/2021 -- 09/2023}
...
\textbf{\textsc{Embedded Software Engineer}} at \textbf{Alta Rail Technology} -- Full time \hfill \textit{02/2021 -- 08/2021}
...
\textsc{Agile Software Development} specialization \hfill \textit{07/2023}\\
